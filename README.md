...
•	Customer Rating & Item Distribution
The goal of this project is to analyze sales trends and business performance metrics to support data-driven decision-making.
